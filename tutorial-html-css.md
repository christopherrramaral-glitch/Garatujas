...
- Antes de seguirmos, imagine um editor de texto como o Microsoft Word ou o Google Docs. estes, você costuma selecionar um trecho de texto e aplicar uma formatação, como negrito, itálico ou sublinhado. No HTML para defenir isso se usamos uma tag (etiqueta) para decidir a formatação
