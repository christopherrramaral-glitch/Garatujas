...
## Introdução
 ...
 - 
 A estrutura **HTML** é composta por uma série de elementos, para definilos utilizamos uma ***tag*** (etiqueta) específica que compoẽm seu tipo de conteúdo e sua função. 
